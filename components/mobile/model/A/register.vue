<template>
	<div :class="['register-modal', { active: rStore.modal }]">
		<div class="register-banner">
			<BaseImg
				:src="getResConfigImage('banner', ImageKeyEnum.login)"
				class="w-full flex-shrink-0 rounded-[8px] absolute left-0 right-0 h-full"
			/>
		</div>
		<BaseIcon name="close" class="p-[10px] absolute -right-[2px] -top-[2px] z-[1] text-[14px] login-close-color" @click="closePopup()" />
		<div class="w-full flex-1 flex flex-col overflow-hidden register-content">
