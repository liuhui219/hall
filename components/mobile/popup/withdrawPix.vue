...
<template>
	<div class="finance-view finance-view-mobile text-center flex flex-col justify-between">
		<div class="px-[15px] flex-1 overflow-auto">
			<p class="mt-[12px] text-sm text-white w-full text-center">{{ $t('D0026', { name: 'Pix' }) }}</p>
			...
			<section class="mt-[24px] text-left gap-[16px] flex flex-col">
		...
		<div class="px-[15px] pb-[16px] text-left pt-[16px]">
			...
			<button class="sys-btn btn-m btn-full-width btn-main" @click="withdrawStore.clickWithdraw(PutGroupEnum.pix)">
				{{ $t('U0002') }}
			</button>
		</div>
	</div>
