...
<script setup lang="ts">
	...
	const homeFooter = defineAsyncComponent({
		loader: () => {
			...
			if (isDesktop) {
				return import(`@/components/desktop/model/${model}/home/footer.vue`)
			}
			return import(`@/components/mobile/model/${model}/home/footer.vue`)
		},
		delay: 100,
		timeout: 10000,
		suspensible: false,
		onError: (err, retry, error, attempts) => {
			...
			HallLog.error('lazy component: footer is load failed!')
		},
	})
</script>
