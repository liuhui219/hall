		...
		<div class="modal-content-login">
			<div class="modal-body flex flex-col">
				<div class="modal-header login-close-container">
					<BaseArrowDown class="back login-close-color text-[18px]" @click="closePopup()" />
					<BaseIcon name="close" class="login-close-color text-[18px]" @click="openRegister()" />
				</div>
				<div class="text-[20px] mt-[87px] mb-[16px] login-white">{{ rStore.codeTip }}</div>
				<div
				...
				<button
					class="sys-btn btn-m btn-l btn-full-width uppercase mt-[140px] !h-[50px] !text-[16px] btn-highlight"
