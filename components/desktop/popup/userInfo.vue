	...
	<section class="userinfo flex flex-col px-[16px] w-full gap-y-[24px] overflow-y-auto overflow-x-hidden" @scroll="userInfoScroll">
		<div class="modal-header">
			<div class="flex justify-end w-full">
				<button class="modal__close pt-[32px] px-[20px]" @click="closePopup()">
					<i class="sysicon-close text-lowlight text-[18px]" />
				</button>
			</div>
		</div>
		<div class="flex items-center shrink-0 user-info-header">
		...
		<BaseWallet :scroll-top="scrollTop" top="325px" />
