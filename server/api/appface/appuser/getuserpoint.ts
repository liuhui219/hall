import { GetUserPoint } from '~~/server/serviceapi/appserver'
import { NullReq, GetUserPointRsp } from '~/types/appserverComponents'
//获取用户金币
export default defineEventHandler(async (event) => {
	...
	let rsp = <GetUserPointRsp>await GetUserPoint(body as NullReq, event)
	return rsp
})
