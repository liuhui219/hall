import { GetNewPayConfig } from '~~/server/serviceapi/appserver'
import { NullReq, GetPayConfigRsp } from '~/types/appserverComponents'
//获取支付配置
export default defineEventHandler(async (event) => {
	...
	let rsp = <GetPayConfigRsp>await GetNewPayConfig(body as NullReq, event)
	return rsp
})
